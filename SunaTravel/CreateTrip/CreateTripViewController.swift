...
//}
//
// тут мб масштабирование получше
...
class CreateTripViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private let descriptionLabel: UILabel = {
        let label = UILabel()
        label.text = "You will get a complete travel package on the beaches. Packages in the form of airline tickets, recommended Hotel rooms, Transportation, Have you ever been on holiday to the Greek ETC"
        label.textColor = .black
        label.font = UIFont.systemFont(ofSize: 17)
        label.numberOfLines = 3 // Initially show 3 lines
        label.lineBreakMode = .byTruncatingTail // Add ellipsis if text overflows
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    }()
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Description Label
            descriptionLabel.topAnchor.constraint(equalTo: aboutDestinationLabel.bottomAnchor, constant: 8),
            descriptionLabel.leadingAnchor.constraint(equalTo: containerView.leadingAnchor, constant: 20),
            descriptionLabel.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -20),

            // Read More Button
            readMoreButton.topAnchor.constraint(equalTo: descriptionLabel.bottomAnchor, constant: 8),
            readMoreButton.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -20),
        ])
    }
    ...
    @objc private func didTapReadMore() {
        ...
        descriptionLabel.numberOfLines = isDescriptionExpanded ? 0 : 3 // If expanded, show all lines, otherwise limit to 3
        readMoreButton.setTitle(isDescriptionExpanded ? "Read less" : "Read more", for: .normal)
...
class PhotoCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        overlayView.addSubview(remainingCountLabel)
        ...
        NSLayoutConstraint.activate([
            ...
            remainingCountLabel.centerXAnchor.constraint(equalTo: contentView.centerXAnchor),
            remainingCountLabel.centerYAnchor.constraint(equalTo: contentView.centerYAnchor)
        ])
    }
