...
protocol BasePlaceProvider {
    func getModel() -> Place
}

struct PlaceCellRepresentable: UIViewRepresentable {
    var placeProvider: BasePlaceProvider
...
struct ExampleBasePlaceProvider: BasePlaceProvider {
    func getModel() -> Place {
